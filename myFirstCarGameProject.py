...
# araba_resmi = pygame.transform.scale(araba_resmi, (100, 150))  # Boyutu ayarla

# arka_plan = pygame.image.load('_car.png')
# arka_plan = pygame.transform.scale(arka_plan, (GENISLIK, YUKSEKLIK))  # Boyutu ayarla
